...
(function () {
  ...
  function injectStyle() {
    ...
    style.textContent =
      ...
      ".ssc-toggle:hover{color:#059669;}" +
      ".ssc-accordion.is-open .ssc-toggle{color:#059669;}" +
      ...
      ".ssc-gain{display:inline-flex;align-items:center;gap:6px;background:rgba(5,150,105,0.10);color:#059669;" +
